  ...
  return (
    <div className="page">
      ...
      <header className="header">
        ...
        <button className="settings-toggle" onClick={() => setShowSettings(s => !s)} aria-label="Settings">
      ...
      <div className="phrases-row">
        {PHRASES.map(p => (
          <button key={p.label} className={`phrase-pill ${text === p.text ? "phrase-pill--on" : ""}`}
      ...
      <div className="card">
        ...
        <div className="card-footer">
          ...
          <div className="footer-actions">
            {text && <button className="btn-clear" onClick={() => { setText(""); stop(); }}>Clear</button>}
      ...
      {isActive && (
        <div className="status-bar">
          <span className={`status-dot ${state === "speaking" ? "status-dot--live" : "status-dot--paused"}`}/>
          <span>{state === "speaking" ? "Speaking…" : "Paused"}</span>
